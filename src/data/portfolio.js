export const formationData = [
    ...
    {
        level: 'TECHNICAL_DEGREE',
        course: 'Internet Computing',
        institution: 'ETEC',
        period: '2016 - 2018',
        status: 'COMPLETED'
    },
...
export const softSkills = [
    'TeamWork.exe', 'ProblemSolving.dll', 'Creativity.sys',
    'CommunicationProtocol', 'AgileLearning', 'Adaptability',
    'CriticalThinking'
];
...
export const projectData = [
    ...
    },
    {
        ...
        description: 'Aplicação web com tema terminal, desenvolvida para aprendizado e utilidade na faculdade, permitindo a execução de códigos python e salvar arquivos.',
...
export const contactConfig = {
    whatsappNumber: "5516993720553",
    whatsappMessage: "Olá! Vi seu portfólio e gostaria de conversar sobre uma oportunidade.",
    email: "kauan_nup@outlook.com",
    github: "https://github.com/kauanfeelipe",
